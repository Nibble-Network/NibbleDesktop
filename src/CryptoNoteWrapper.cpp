...
public:
  InprocessNode(const CryptoNote::Currency& currency, Logging::LoggerManager& logManager, const CryptoNote::CoreConfig& coreConfig,
    ...
    m_core(currency, &m_protocolHandler, logManager, blockchainIndexesEnabled), //Mad add Blockchainindicies Argument
...
private:
  ...
  bool blockchainIndexesEnabled; //Mad define Blockchainindicies var
